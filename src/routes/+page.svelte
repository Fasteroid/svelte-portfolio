...
<body>
    <div class="margins">
        <section>
            ...
            <div class="p">
                <img src="{base}/assets/placeholder.png" style="float:left; max-height: 245px; margin-left: 0px;" 
            ...
            <div class="p">
                <img src="{base}/assets/placeholder.png" style="float:right; max-height: 245px; margin-right: 0px;"
