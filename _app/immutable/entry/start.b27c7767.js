...
import { S as SCROLL_KEY, a as SNAPSHOT_KEY, I as INDEX_KEY, g as get_base_uri, f as find_anchor, b as get_link_info, c as get_router_options, s as scroll_state, i as is_external_url, d as stores, P as PRELOAD_PRIORITIES, e as init } from "../chunks/singletons.c6e8b1bc.js";
import { b as base } from "../chunks/paths.31adb4c4.js";
...
function create_client(app, target) {
  ...
  async function load_route({ id, invalidating, url, params, route }) {
    ...
    const invalid_server_nodes = loaders.map((loader, i) => {
      ...
      const invalid = !!loader?.[0] && (previous?.loader !== loader[1] || has_changed(parent_invalid, route_changed, url_changed, previous.server?.uses, params));
      if (invalid) {
        parent_invalid = true;
      }
      return invalid;
    ...
    const branch_promises = loaders.map(async (loader, i) => {
      ...
      const valid = (!server_data_node || server_data_node.type === "skip") && loader[1] === previous?.loader && !has_changed(parent_changed, route_changed, url_changed, previous.universal?.uses, params);
      if (valid)
        return previous;
      parent_changed = true;
  ...
  async function navigate({
    ...
    if (navigation_result.props.page?.url && navigation_result.props.page.url.pathname !== url.pathname) {
