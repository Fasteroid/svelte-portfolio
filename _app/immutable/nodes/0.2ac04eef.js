import{_ as wn}from"../chunks/_layout.24c3be41.js";import{s as H,n as L,c as O,d as J,u as K,g as Q,e as U}from"../chunks/scheduler.2cdf953d.js";import{S as q,i as F,g as v,s as k,x as G,h as w,y as E,f as g,c as z,j as _,k as b,z as u,a as C,A as Y,m as B,n as W,B as I,r as X,u as nn,v as tn,d as S,t as A,w as en}from"../chunks/index.65d7753f.js";import{e as D,p as P}from"../chunks/loader.28d15c1a.js";import{b as V}from"../chunks/paths.6d1d78e9.js";import{p as Z}from"../chunks/stores.7b9072c6.js";function j(s,n,r){const o=s.slice();return o[3]=n[r],o}function N(s,n,r){const o=s.slice();return o[6]=n[r],o}function an(s){let n,r,o=D(s[3].getChildren()),a=[];for(let t=0;t<o.length;t+=1)a[t]=M(N(s,o,t));return{c(){n=v("div"),r=v("div");for(let t=0;t<a.length;t+=1)a[t].c();this.h()},l(t){n=w(t,"DIV",{class:!0});var l=_(n);r=w(l,"DIV",{class:!0});var e=_(r);for(let p=0;p<a.length;p+=1)a[p].l(e);e.forEach(g),l.forEach(g),this.h()},h(){b(r,"class","dropdown-onload-wrapper"),b(n,"class","dropdown-content")},m(t,l){C(t,n,l),u(n,r);for(let e=0;e<a.length;e+=1)a[e]&&a[e].m(r,null)},p(t,l){if(l&1){o=D(t[3].getChildren());let e;for(e=0;e<o.length;e+=1){const p=N(t,o,e);a[e]?a[e].p(p,l):(a[e]=M(p),a[e].c(),a[e].m(r,null))}for(;e<a.length;e+=1)a[e].d(1);a.length=o.length}},d(t){t&&g(n),Y(a,t)}}}function M(s){let n,r,o=s[6].pageData.title+"",a,t;return{c(){n=v("a"),r=v("span"),a=B(o),t=k(),this.h()},l(l){n=w(l,"A",{href:!0});var e=_(n);r=w(e,"SPAN",{});var p=_(r);a=W(p,o),p.forEach(g),t=z(e),e.forEach(g),this.h()},h(){b(n,"href",s[6].webPath),I(n,"active",s[0](`${s[6].webPath}`))},m(l,e){C(l,n,e),u(n,r),u(r,a),u(n,t)},p:L,d(l){l&&g(n)}}}function R(s){let n,r,o,a=s[3].pageData.title+"",t,l,e=s[3].getChildren(),p,d=e&&an(s);return{c(){n=v("div"),r=v("div"),o=v("a"),t=B(a),l=k(),d&&d.c(),p=k(),this.h()},l(i){n=w(i,"DIV",{class:!0});var c=_(n);r=w(c,"DIV",{});var x=_(r);o=w(x,"A",{href:!0});var h=_(o);t=W(h,a),h.forEach(g),x.forEach(g),l=z(c),d&&d.l(c),p=z(c),c.forEach(g),this.h()},h(){b(o,"href",s[3].webPath),I(r,"dropdown-head",!0),I(r,"active",s[0](s[3].webPath)),b(n,"class","dropdown")},m(i,c){C(i,n,c),u(n,r),u(r,o),u(o,t),u(n,l),d&&d.m(n,null),u(n,p)},p(i,c){e&&d.p(i,c)},d(i){i&&g(n),d&&d.d()}}}function on(s){let n,r=`@import url("https://fonts.googleapis.com/css2?family=Recursive:wght@600&display=swap");
...
@font-face {
  font-family: minecraft_dev;
  src: url("../assets/fonts/minecraft.woff") format("woff");
}
@font-face {
  font-family: minecraft_prod;
  src: url("/svelte-portfolio/assets/fonts/minecraft.woff") format("woff");
}
.minecraftsplash {
  color: #ff0;
  position: absolute;
  z-index: 1;
  left: 100%;
  font-family: "minecraft_prod", "minecraft_dev", "fixedsys";
  font-weight: normal;
  font-style: normal;
  font-size: 11pt;
  text-align: center;
...
}`,o,a,t,l='<div class="home-wrapper"><span>FAST&#39;S CODE CREATIONS</span> <div class="minecraftsplash">Now with Svelte!</div></div>',e,p,d,i=`<div class="dropdown-head"><span>Links</span></div> <div class="dropdown-content"><div class="dropdown-onload-wrapper"><a href="https://discord.com/users/276913653230469122/" target="_blank"><img src="${V}/assets/icons/discord.svg" class="icon" alt=""/> <span>Discord</span></a> <a href="https://github.com/Fasteroid/" target="_blank"><img src="${V}/assets/icons/github.svg" class="icon" alt=""/> <span>Github</span></a></div></div>`,c,x=D(P.getChildren()),h=[];for(let m=0;m<x.length;m+=1)h[m]=R(j(s,x,m));return{c(){n=v("style"),n.textContent=r,o=k(),a=v("nav"),t=v("div"),t.innerHTML=l,e=k(),p=v("div"),d=v("div"),d.innerHTML=i,c=k();for(let m=0;m<h.length;m+=1)h[m].c();this.h()},l(m){const y=G("svelte-qle18i",document.head);n=w(y,"STYLE",{lang:!0,"data-svelte-h":!0}),E(n)!=="svelte-cdy35j"&&(n.textContent=r),y.forEach(g),o=z(m),a=w(m,"NAV",{});var f=_(a);t=w(f,"DIV",{class:!0,"data-svelte-h":!0}),E(t)!=="svelte-1s6thel"&&(t.innerHTML=l),e=z(f),p=w(f,"DIV",{class:!0});var $=_(p);d=w($,"DIV",{class:!0,"data-svelte-h":!0}),E(d)!=="svelte-1tp0efu"&&(d.innerHTML=i),c=z($);for(let T=0;T<h.length;T+=1)h[T].l($);$.forEach(g),f.forEach(g),this.h()},h(){b(n,"lang","scss"),b(t,"class","home"),b(d,"class","dropdown"),b(p,"class","pages")},m(m,y){u(document.head,n),C(m,o,y),C(m,a,y),u(a,t),u(a,e),u(a,p),u(p,d),u(p,c);for(let f=0;f<h.length;f+=1)h[f]&&h[f].m(p,null)},p(m,[y]){if(y&1){x=D(P.getChildren());let f;for(f=0;f<x.length;f+=1){const $=j(m,x,f);h[f]?h[f].p($,y):(h[f]=R($),h[f].c(),h[f].m(p,null))}for(;f<h.length;f+=1)h[f].d(1);h.length=x.length}},i:L,o:L,d(m){m&&(g(o),g(a)),g(n),Y(h,m)}}}function rn(s,n,r){let o;O(s,Z,l=>r(1,o=l));const a=o.url.pathname;function t(l){return a.startsWith(l)}return[t]}class sn extends q{constructor(n){super(),F(this,n,rn,on,H,{})}}function ln(s){let n,r=`@import url("https://fonts.googleapis.com/css2?family=Roboto+Mono:wght@400&display=swap");
body, html {
  margin: 0;
  padding: 0;
}
