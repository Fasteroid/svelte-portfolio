import{s as d,n as s}from"../chunks/scheduler.b0c1c2c3.js";import{S as c,i as m,s as y,g as p,x as f,f as i,c as u,h as g,y as b,a as l}from"../chunks/index.f8c5d532.js";import{b as r}from"../chunks/paths.17c8943e.js";function v(h){let a,e,n=`<div class="margins"><section><h1><b>About Me</b></h1> <div class="p"><img src="${r}/assets/aboutme/fasteroidbruh.jpg" style="float:left; max-height: 245px; margin-left: 0px;" alt="A 3D-printed replica Expression 2 chip from Garry&#39;s Mod."/>
...
into a massive power trip for me.  I&#39;m still addicted today.<br/> <div style="clear:both"></div> <br/>
...
<br/></div> <div class="p"><img src="${r}/assets/aboutme/ody.jpg" style="float:right; max-height: 245px; margin-right: 0px;" alt="2018 claiming of the Renatra Fusca Creativity Award at DE State Finals."/>
...
Odyssey of the Mind taught me a lot<div class="emdash">—</div>mainly that it usually isn&#39;t feasable for one person to work on everything.  
...
will struggle to pick something that truly defeats everyone on the team.<br/> <div style="clear:both"></div> <br/></div> <div class="p"><img src="${r}/assets/aboutme/gmodfriends.jpg" style="float:left; max-height: 245px; margin-left: 0px;" alt="Friends on E2 Beyond Infinity."/>
...
Perhaps I can be of use to you!<br/></div> <div class="emdash">—</div>Fast<br/> <br/>
PS: SVELTE! SVELTE! SVELTE!</section></div>`;return{c(){a=y(),e=p("body"),e.innerHTML=n,this.h()},l(t){f("svelte-fgvcgy",document.head).forEach(i),a=u(t),e=g(t,"BODY",{"data-svelte-h":!0}),b(e)!=="svelte-8vnltm"&&(e.innerHTML=n),this.h()},h(){document.title="About Me"},m(t,o){l(t,a,o),l(t,e,o)},p:s,i:s,o:s,d(t){t&&(i(a),i(e))}}}class x extends c{constructor(a){super(),m(this,a,null,v,d,{})}}export{x as component};
